    ...
    public ResponseEntity<?> getUserByEmail(@PathVariable String email) {
        try {
            ...
            if (userOptional.isPresent()) {
                ...
                return ResponseEntity.badRequest().body("User not found with email: " + email + ", existsByEmail: " + exists);
            }
        } catch (Exception e) {
    ...
    public ResponseEntity<?> checkPassword(@RequestBody PasswordCheckRequest request) {
        try {
            ...
            if (userOptional.isPresent()) {
                ...
                return ResponseEntity.ok("Password matches: " + matches + ". Stored password hash: " + user.getPassword());
            } else {
